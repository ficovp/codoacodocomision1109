...
const modificarM = (b) => {
    ...
    <button type="button" onclick="cambiarDatos(b)" class="btn btn-primary" id="btn">Agregar Datos</button>
  </form>
    `;
};
const mostrarMascotas = () => {
    ...
    for (let a = 0; a < mascotas.length; a++) {
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary" onclick="modificarM(${a})">Modificar mascota</a>
        </div>
      </div>
        `;
    }
